...
public class ToolBox {
    ...
    protected synchronized DataTools getNextDataTools() {
        if(dataTools[dataToolsCounter] == null) dataTools[dataToolsCounter] = new DataTools();
    ...
    protected synchronized NetTools getNextNetTools() {
        if(dataTools[netToolsCounter] == null) netTools[netToolsCounter] = new NetTools();
    ...
    protected synchronized ReflectionTools getNextReflectionTools() {
        if(reflectionTools[reflectionToolsCounter] == null) reflectionTools[reflectionToolsCounter] = new ReflectionTools();
