 ...
 * principalmente na construção do pacote, definindo sua estrutura e tamanho.
 * 
...
public interface KadProtocol
{
     ...
     * Utilizado principalmente na quebra de valores de chaves em diversos
     * pacotes.
     */
    public static final int PIECE_LENGTH = 1;

    /*
     * Constantes para construção dos dados encapsulados no pacote que trafega
     * na rede
     */

    /**
     * Área de identificação do RPC, podendo ser do tipos PING, STORE, FIND_NODE
     * e FIND_VALUE.
     */
    public static final int TYPE_AREA = 0;

    /**
     * Área de identificação de encaminhamento do pacote, que pode ser uma
     * requisiçao (Valor 0) ou então uma resposta (Valor > 0), sendo este número
     * um identificador numérico da resposta pois uma requisição pode gerar mais
     * de uma resposta.
     */
    public static final int RESPONSE_AREA = TYPE_AREA + TYPE_AREA_LENGTH;

    /**
     * Área de identificação do RPC. Todo RPC possui um identificador aleatório
     * que é compartilhado entre o destinatário e as respostas do remetente
     */
    public static final int RPC_ID_AREA = RESPONSE_AREA + RESPONSE_AREA_LENGTH;

    /**
     * Área de identificação do remetente do RPC. Todo RPC possui o
     * idnetificador do remetente imbutido.
     */
    public static final int SENDER_ID_AREA = RPC_ID_AREA + RPC_ID_LENGTH;

    /**
     * Área de identificação do destinatário do RPC. Todo RPC possui o
     * idnetificador do destinatário embutido para minimizar forjamento de
     * endereços e ataques DoS.
     */
