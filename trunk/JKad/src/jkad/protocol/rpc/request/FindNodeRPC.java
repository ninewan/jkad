...
public class FindNodeRPC extends RPC
{
    ...
    public void setSearchedNodeID(BigInteger searchedNodeID) throws KadProtocolException
    {
        ...
        {
            throw new KadProtocolException("SearchedNodeID must have " + KadProtocol.NODE_ID_LENGTH * 8 + " bits, " + "found " + searchedNodeID.bitLength() + " bits");
        } else
        {
